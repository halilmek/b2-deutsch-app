...
| 5 | b1_05 | Nominalisierung | 60 | 🔄 In Progress (q001–q060 added 2026-05-26) |
...
**B1 Total: 461 questions (target: 1,000)**
...
| 5 | Nominalisierung | 100 | 60 | 🔄 In Progress |
...
| q041–q060 | 20 (verbal→nominal transformations: weil→wegen, bevor→vor, obwohl→trotz, indem→durch, etc.) | `a9e2c1f` |

**b1_05 Total: 60 questions** (target: 100)
...
2. **Next Priority:** B1 module b1_05 (40 more) → b1_06–b1_10 (500 questions)
...
_Last updated: 2026-05-26 11:04 UTC_
