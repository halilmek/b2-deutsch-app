...
| **C2** | **80** | **~2,000** | **🔄 In Progress** |
| **Total** | **6,260** | **~8,000** | 🔄 In Progress |
...
| # | ID | Topic | Questions | Status |
|---|----|-------|-----------|--------|
| 1 | c2_01 | Nominalstil & Verbalstil | 80 | 🔄 In Progress (needs 20 more for 100) |

**C2 Total: 80 questions (target: ~2,000)**
...
7. **C2 started:** c2_01 at 80 questions (q001-q080 added)
...
**c2_01 Total: 80 questions** (needs 20 more to reach 100) 🔄
