...
async function main() {
  ...
  await firestorePost('b2_02', toFields({
    ...
    subTopics: 'Reflexive Verben: Akkusativ (Q1-10), Reflexive Verben: Dativ (Q11-20)',
    questionCount: 20,
    type: 'module'
  }));
  ...
  // Import questions
  console.log('📝 Importing 20 questions...\n');
  ...
  console.log('\n🎉 Done! 20 questions imported to moduleQuizQuestions');
