...
const questions = [
  ...
  { id: 'b2_01_bis_q003', module: 'B2', topicNumber: '1. Topic', topicName: 'Konnektoren', konnektor: 'wenn', questionText: '___ ich Zeit habe, kann ich dir helfen.', options: ['Während', 'Wenn', 'Bevor', 'Sobald'], correctAnswer: 'Wenn', explanation: '"Bis" zeigt hier die Bedingung — bis ich Zeit habe.', difficulty: 'medium', level: 'B2' },
  ...
  { id: 'b2_01_bis_q008', module: 'B2', topicNumber: '1. Topic', topicName: 'Konnektoren', konnektor: 'nachdem', questionText: '___ alle Gäste gegangen waren, haben wir aufgeräumt.', options: ['Während', 'Nachdem', 'Bevor', 'Sobald'], correctAnswer: 'Nachdem', explanation: '"Bis" zeigt den Endpunkt — aufgeräumt wurde nach dem Gehen der Gäste.', difficulty: 'medium', level: 'B2' },
  ...
  { id: 'b2_01_bis_q010', module: 'B2', topicNumber: '1. Topic', topicName: 'Konnektoren', konnektor: 'nachdem', questionText: '___ das Spiel zu Ende war, haben wir geklatscht.', options: ['Während', 'Nachdem', 'Bevor', 'Als'], correctAnswer: 'Nachdem', explanation: '"Bis" zeigt den Zeitpunkt des Klatschens — als das Spiel endete.', difficulty: 'medium', level: 'B2' },
